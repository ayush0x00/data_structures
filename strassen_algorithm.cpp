...
std::vector<std::vector<int> >matrix_a={{2,3},{5,6}};
std::vector<std::vector<int> >matrix_b={{1,6},{9,8}};
std::vector<std::vector<int> > result={{0,0},{0,0}};

void strassen_mul(std::vector<std::vector<int> > a,std::vector<vector<int>> b){
